...
Widget logo(double height_, double width_) {
  return Image.asset(
    'assets/images/parish_aid_horiz_b_trans.png',
    height: height_,
    width: width_,
  );
}

Widget richText(String text, double fontSize) {
  return Text.rich(
    TextSpan(
      style: GoogleFonts.inter(
        fontSize: fontSize,
...
Widget emailTextField(TextEditingController controller, Size size) {
  return Padding(
...
Widget passwordTextField(TextEditingController controller, Size size) {
  return Padding(
    padding: const EdgeInsets.symmetric(horizontal: 16.0),
    child: SizedBox(
...
Widget triggerActionButtonBlue(Size size, String text, {Color? color}) {
  return Container(
    margin: EdgeInsets.only(left: 15, right: 15),
    alignment: Alignment.center,
    height: size.height / 13,
