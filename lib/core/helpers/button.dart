...
import 'package:parish_aid_admin/core/helpers/txt.dart';
...
class _ButtonState extends State<Button> {
  ...
  Widget iconWidget() {
    ...
    if (_icon is IconData)
      child = Icon(_icon, color: _textColor, size: widget.fontSize);
  ...
  Color get _buttonColor =>
      processing ? _darkenButtonColor : widget.buttonColor;
